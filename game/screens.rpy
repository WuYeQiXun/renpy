...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("作品简介") action ShowMenu("synopsis")
        ...
        textbutton _("更新日志") action ShowMenu("changelog")

        textbutton _("致谢") action ShowMenu("thanks")
...
screen preferences():
    ...
    use game_menu(_("设置"), scroll="viewport"):
        ...
        vbox:
            ...
            textbutton _("显示视角标签"):
                action ToggleField(persistent, "show_pov")
...
screen chapter_select():
    ...
    use game_menu(_("章节选择"), scroll="viewport"):
        vbox:
            ...
            textbutton _("引子"):
                action [Function(set_temp_hide, True), Start("prologue")]
                sensitive persistent.chapter_unlocked[0]

            textbutton _("第一章：识"):
                action [Function(set_temp_hide, True), Start("chapter1")]
                sensitive persistent.chapter_unlocked[1]

            textbutton _("第二章：近"):
                action [Function(set_temp_hide, True), Start("chapter2")]
                sensitive persistent.chapter_unlocked[2]

            textbutton _("第三章：疑"):
                action [Function(set_temp_hide, True), Start("chapter3")]
                sensitive persistent.chapter_unlocked[3]

            textbutton _("第四章：复"):
                action [Function(set_temp_hide, True), Start("chapter4")]
                sensitive persistent.chapter_unlocked[4]

            textbutton _("第五章：解"):
                action [Function(set_temp_hide, True), Start("chapter5")]
                sensitive persistent.chapter_unlocked[5]

            textbutton _("第六章：结"):
                action [Function(set_temp_hide, True), Start("chapter6")]
                sensitive persistent.chapter_unlocked[6]

#视角框
screen pov_display():
    if persistent.show_pov and not temp_hide_pov:
        frame:
            xalign 1.0 yalign 1.0
            xoffset -20 yoffset -20
            background pov_bg_colors.get(current_pov, "#cccccc")
            xpadding 15 ypadding 8
            text "当前视角：[current_pov!t]" size 22 color pov_text_colors.get(current_pov, "#000000")

#作品简介
screen synopsis():
    tag menu
    use game_menu(_("作品简介"), scroll="viewport"):
        vbox:
            label _("作品简介")
            text _("""
            \n故事简介：            
            \n一个不同寻常的故事——高中生的暗恋……怎么和书上的不太一样？
            \n两个相互交织的视角——无论如何都想伸手去触及的可能，却始终够不到吗……
            \n三段难以理清的关系——对家庭、对他人、对自我……应该如何破开迷惘？

            \n当生活黯无亮光，你将跟随这位主人公——明里，一同踏入他的漫漫长夜，去找寻，他的亮光。
            \n{i}“如果能有光带我离开……”{/i}
            \n{i}“那是引领我走出长夜的光……”{/i}
            \n{i}“那束我曾以为的‘光’……”{/i}
            ...
            \n内容警告：
            \n本作深入探讨了青少年自我成长相关的主题，包含对同性情感的探索、自我身份的认同危机的描写，以及家庭矛盾的刻画，还有少量对暴力行为的非写实描绘。此外，游戏中还存在自杀念头、自残行为的描述，涉及心理创伤与恢复的过程，可能引发相关经历者的不适。故事整体氛围沉重压抑，请以照顾好您的情绪为前提，阅读此作品。
            

            \n内容相关：
            \n1.目前只支持中文
            \n2.纯文本13000+字，预计游玩时长30~40分钟
            \n3.单一故事线，无任何选项与分支
            \n4.本作暂无立绘与cg，或许以后会进行补充（情节可能会润色）


            \n如在游玩过程中发现错误或是情节的不足之处，欢迎留言！
            \n感谢您的游玩与支持！
            """)
...
screen thanks():
    tag menu
    use game_menu(_("致谢"), scroll="viewport"):
        vbox:
            label _("致谢（不分先后）")
            text _("""
            \n感谢FVN批评社团开展此次【FVN Game Jam #0 言语肇始】活动并为活动整理的一份文档，提供了很多资源获取路径以寻找免费素材下载并使用，让我有机会能完成这个作品。
            \n感谢 FVN批评 FVN Game Jam#0 交流群 中热心善良的群友们的支持鼓励与答疑解惑。
            \n感谢我的朋友们为我的文案提供了宝贵的修改意见 {s}（其实现在这版也不算很满意，这是可以说的吗）{/s}。
            \n感谢b站大佬们提供的Ren'Py教程视频，解决了我程序设计过程中的一部分问题。
            \n感谢一位热心群友在我代码编写过程中为我讲解代码原理和提供实例演示。
            \n感谢这次活动，让我能有一次尝试、学习与突破的机会。
            \n感谢屏幕前的每一位读者愿意花时间体验我的拙作！
            """)
...
screen changelog():
    ...
    use game_menu(_("更新日志"), scroll="viewport"):
        vbox:
            label _("更新日志")
            text _("""
            \n{size=60}版本  1.1{/size}   更新时间  2026.2.15
            \n更新内容：
            \n1.为视角框更换底色以及字体颜色，并在更换视角时出现一个无文字的对话框，便于读者发现视角的更换。
            \n2.修复了从“引子”到“第一章：识”时右下角视角框不会隐藏的问题。
            \n3.“作品简介”增加部分内容。
            \n4.增加了“更新日志”功能，以供迅速了解更新的具体内容。
            \n5.“第四章：复”增改部分文本（约400字）以更好地过渡剧情，并修复了一处语序错误。
            """)
