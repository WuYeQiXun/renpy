...
## 游戏内文本使用的字体。
define gui.text_font = "LXGWWenKaiMono-Regular.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "LXGWWenKaiMono-Regular.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "LXGWWenKaiMono-Regular.ttf"
